...
public class CaptureFragment extends Fragment implements SurfaceHolder.Callback {
    ...
    private TextView lightSwitch, enterPassWord;

    private boolean lightSwitchFlag = false;
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        lightSwitch = (TextView) view.findViewById(R.id.light_switch);
        lightSwitch.setOnClickListener(lightSwitchListener);

        enterPassWord = (TextView) view.findViewById(R.id.enter_password);
        enterPassWord.setOnClickListener(enterPswListener);

        final ImageView arrow_left = (ImageView) view.findViewById(R.id.comm_back_arrow);
    ...
    private final View.OnClickListener enterPswListener = new View.OnClickListener() {
        @Override
        public void onClick(View view) {
    ...
    private final View.OnClickListener lightSwitchListener = new View.OnClickListener() {
        @Override
        public void onClick(View view) {
            if (isLightOpen()) {
