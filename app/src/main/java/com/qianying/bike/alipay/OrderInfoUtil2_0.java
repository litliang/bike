package com.qianying.bike.alipay;
...
public class OrderInfoUtil2_0 {
	...
	public static Map<String, String> buildOrderParamMap(String app_id, boolean rsa2) {
		Map<String, String> keyValues = new HashMap<String, String>();
		AlipayOrder alipayOrder = AlipayOrder.newInstance();
		String timeout_express =alipayOrder.getTimeout_express();
		String product_code = alipayOrder.getProduct_code();
		String subject = alipayOrder.getSubject();
		String out_trade_no = alipayOrder.getOut_trade_no();
		String total_amount = alipayOrder.getTotal_amount();
		String timestamp = alipayOrder.getCreatetime();
...
//		keyValues.put("biz_content", "{\"timeout_express\":\"30m\",\"product_code\":\"QUICK_MSECURITY_PAY\",\"total_amount\":\"0.01\",\"subject\":\"1\",\"body\":\"我是测试数据\",\"out_trade_no\":\"" + getOutTradeNo() +  "\"}");
		keyValues.put("biz_content",json.toString());
